...
export default function ConsultationScreen() {
  ...
  return (
    <ThemedView style={styles.flex}>
      <Stack.Screen options={{ title: '상담 기록', presentation: 'modal' }} />
      <KeyboardAvoidingView
        style={styles.flex}
        ...
        <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
          ...
          <Button label={saving ? '저장 중…' : '저장'} onPress={save} disabled={saving} />
          <Muted>
            저장하면 고객의 마지막 연락일이 상담일로 갱신됩니다{autoSummarize ? ' (다음 관리일 포함).' : '.'}
          </Muted>
        </ScrollView>
      </KeyboardAvoidingView>
    </ThemedView>
